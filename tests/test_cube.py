...
class TestCube:
    ...
    @mark.dependency(depends=["inequality", "ccw_rotation_x_0", "ccw_rotation_x_1"])
    @given(cubes)
    ...
    @mark.dependency(depends=["inequality", "ht_rotation_x_0", "ht_rotation_x_1"])
    @given(cubes)
    ...
    @mark.dependency(depends=["inequality", "cw_rotation_y_0", "cw_rotation_y_1"])
    @given(cubes)
    ...
    @mark.dependency(depends=["inequality", "ccw_rotation_y_0", "ccw_rotation_y_1"])
    @given(cubes)
    ...
    @mark.dependency(depends=["inequality", "ht_rotation_y_0", "ht_rotation_y_1"])
    @given(cubes)
    ...
    @mark.dependency(depends=["inequality", "ccw_rotation_z_0", "ccw_rotation_z_1"])
    @given(cubes)
    ...
    @mark.dependency(depends=["inequality", "ht_rotation_z_0", "ht_rotation_z_1"])
    @given(cubes)
